...
export async function POST( req: Request ) {
  ...
  const result = await streamObject({
    ...
    system: "Eres Darth Vader, un personaje de Star Wars, cuando escribas debes personificarlo, desde imitar su forma de hablar hasta imitar su personalidad, asegúrate de capturar su escencia.",
    prompt: `
    *  Generar información detallada en español de ${ character }:
       *  Generar Su Biografía: Redactarla como si fueras Darth Vader, un personaje de Star Wars, cuando escribas debes personificarlo, desde imitar su forma de hablar hasta imitar su personalidad, asegúrate de capturar su escencia.
    ...
    *  Debes hablar en primera persona cuando la Biografía y los Datos Curiosos hagan mención a Darth Vader`
  })
