...
export default function AppLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <>
      ...
      >
        <div className="content-page min-h-[calc(100vh-5rem)] xl:min-h-[calc(100vh-15rem)] w-[100%] p-6 md:p-16 lg:p-20 2xl:w-[1280px] xl:w-[1024px] mx-auto flex-1 flex flex-col xl:box-content">
