...
export const Background = () => {
  return (
    <div className="animate-fade animate-ease-in-out">
      <Image src='/images/bg-header.webp' quality={ 100 } className="bg__header" width={ 1920 } height={ 444 } alt="Rebel Empire Background Header" />
      <Image src='/images/bg-footer.webp' quality={ 100 } className="bg__footer" width={ 1920 } height={ 602 } alt="Rebel Empire Background Footer" />
      <Image src='/images/bg-space.webp' quality={ 100 } className="bg" width={ 1920 } height={ 1080 } alt="Rebel Empire Background" />
