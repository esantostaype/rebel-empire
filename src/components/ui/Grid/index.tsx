...
export const Grid = ({ data, pageNumber, totalPages, link, transparentImage }: GridProps) => {  
  ...
  return (
    <>
      <div className={`${ transparentImage ? "mb-8 mt-16 md:mt-4" : "mb-16" } grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 gap-x-4 gap-y-7 md:gap-x-8 md:gap-y-11`}>
